...
from hmr4d.model.pgmotion.utils.postprocess import pp_static_joint, pp_static_joint_cam, process_ik


class pgmotionPL(pl.LightningModule):
    def __init__(
        self,
        pipeline,
        optimizer=None,
...
MainStore.store(name="pgmotion_pl", node=pgmotion_pl, group="model/pgmotion")
